--проверить правильные ли номера в РФ и Казахстан попадают. ОК.
--коды стран не задваиваются
WITH a AS (
...
FROM a
WHERE STARTS_WITH(phone,'7') AND (STARTS_WITH(phone,'76') OR STARTS_WITH(phone,'77'))