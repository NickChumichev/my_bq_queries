...
, b AS ( --список цветочных магазинов 
SELECT
  id AS shop_id,
  name,
  translit,
...
WHERE id IN (SELECT shop_id FROM `funnel-flowwow.MYSQL_EXPORT.f_shop_main_assortment` WHERE range_group_id = 1) -- категория цветы и подарки
