...
SELECT DISTINCT 
  COALESCE(_sub_1.month_of_registration,_sub_4.month_of_registration) AS month_of_registration,
  COALESCE(_sub_1.country_by_phone,_sub_4.country_by_phone) AS country_by_phone,
  purchase_period,
  COALESCE(_sub_1.category_name, _sub_4.category_name) AS category_name,
  registered_user
FROM
  (
SELECT
  month_of_registration,
  -- sub_4.month_of_registration AS sub_4_month_of_registration,
  -- COALESCE(sub_1.month_of_registration,sub_4.month_of_registration) AS month_of_registration,
  purchase_period,
  -- COALESCE(sub_1.country_by_phone,sub_4.country_by_phone) AS country_by_phone,
  country_by_phone,
  -- sub_4.country_by_phone AS sub_4_country_by_phone,
  -- COALESCE(sub_1.category_name, sub_4.category_name) AS category_name,
  category_name,
  -- sub_4.category_name AS sub_4_category_name,
  -- sub_4.registered_user,
  -- sub_4.month_of_registration,
  -- sub_4.country_by_phone,
  -- sub_4.category_name AS category_name_sub_4,
FROM sub_1) AS _sub_1
FULL JOIN sub_4 AS _sub_4 USING(month_of_registration,country_by_phone,category_name)
-- WHERE sub_1.purchase_period IS NOT NULL