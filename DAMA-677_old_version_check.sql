...
-- WHERE country_by_phone =  'other country' AND month_of_registration = '2023-01-01' 
ORDER BY month_of_registration, country_by_phone ASC
)
-- SELECT
...
-- AND country_by_phone =  'other country' AND month_of_registration = '2023-01-01' 
...
SELECT
  ...
  i.country_by_phone,
  i.category_name,
  i.first_month_purchases AS first_month_purchases_non_normolized,
  SUM( i.first_month_purchases) OVER (PARTITION BY  i.month_of_registration, i.country_by_phone) AS sum_window,
